...
assert.equal(portal.exists,true);assert.equal(portal.receivesPointer,true);
...
const result={baseline,after,additionalRequests:requests-requestsBefore,zoomTracksFrame:zoom,panDelta:panAfter.x-panBefore.x,pinchCaptured:pinch,widthOnly,cssZoom:zoomOnly,actualMobile,portalFallback:portal,errors};
