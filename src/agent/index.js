...
export async function getAgentTemplates() {
  ...
  return {
    ...
    cursorCommand: "Use the Unship skill for this request. If this project has `.agents/skills/unship/SKILL.md`, follow it. Otherwise run `npx -y @unship/cli@latest install --print-skill` and follow the printed skill as the reference workflow. Interpret arguments as the target, count, style, scope, or local surface to compare: $ARGUMENTS\n",
