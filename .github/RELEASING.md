...
2. Run `npm ci`, `npm run verify`, and `npm publish --dry-run`. The package file list is enforced by `test/package-smoke.test.js`; keep generated artifacts and plugin-only files out of npm.
